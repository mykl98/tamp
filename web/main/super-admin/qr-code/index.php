...
<head>
    ...
    <title>Super Admin | QR Code Generator</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">QR Code Generator</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <canvas id="qr-container-canvas"></canvas>
                                <div class="form-group">
                                    <label for="qr-text" class="col-form-label">QR Text:</label><span class="text-danger">*</span>
                                    <input type="text" class="form-control form-control-sm" id="qr-text">
                                </div>
                            </div>
                            <div class="card-footer">
                                <p id="qr-gen-error" class="text-danger font-italic small"></p>
                                <button class="btn btn-sm bg-success" onclick="generateQR()"><span class="fa fa-refresh"></span> Generate</button>
                                <button class="btn btn-sm bg-info" onclick="downloadQR()"><span class="fa fa-download"></span> Download</button>
                            </div>
                        </div>
                    </div>
                </div>

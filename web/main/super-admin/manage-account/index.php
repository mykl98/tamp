                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success ml-2" onclick="addAccount()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="account-firstname" class="col-form-label">Firstname:<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control form-control-sm" id="account-firstname">
                                </div>
                                <div class="form-group">
                                    <label for="account-middlename" class="col-form-label">Middlename:<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control form-control-sm" id="account-middlename">
                                </div>
                                <div class="form-group">
                                    <label for="account-lastname" class="col-form-label">Lastname:<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control form-control-sm" id="account-lastname">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="account-username" class="col-form-label">Username:<span class="text-danger"> *</span></label>
                                    <input type="text" class="form-control form-control-sm" id="account-username">
                                </div>
                                <div class="form-group">
                                    <label for="account-status" class="col-form-label">Status:<span class="text-danger"> *</span></label>

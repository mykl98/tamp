                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3 id="school-count">0</h3>
                                    <p>Schools</p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-school"></i>
                                </div>
                                <a href="../manage-school" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                    ...
                    <dic class="row">
                        <div class="col">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="school-list-table-container"></div>
                                </div>
                            </div>
                        </div>
                    </div>

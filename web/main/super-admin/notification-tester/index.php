...
<head>
    ...
    <title>Super Admin | Notification Tester</title>
    ...
    <!--Select2-->
    <link rel="stylesheet" href="<?php echo $baseUrl;?>/system/plugin/select2/css/select2.min.css">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Notification Tester</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo $baseUrl;?>">Home</a></li>
                                <li class="breadcrumb-item active">Notification Tester</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-4">
                        <div class="card border border-info rounded">
                            <div class="card-body">
                                <div id="school-select-container"></div>
                                <div id="student-select-container"></div>
                                <div class="form-group">
                                    <label class="control-label" for="notif-1-message">Test Announcement:</label>
                                    <textarea class="form-control form-control-sm" id="notif-1-message"></textarea>
                                </div>
                                <p id="notif-1-send-error" class="text-danger font-italic small ml-2"></p>
                                <div class="form-group text-right">
                                    <button class="btn btn-info btn-sm" onclick="sendNotif1()">Send Announcement</button>
                                    <button class="btn btn-success w-25 btn-sm" onclick="sendNotif1Activity('login')">LOGIN</button>
                                    <button class="btn btn-danger w-25 btn-sm" onclick="sendNotif1Activity('logout')">LOGOUT</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-4">
                        <div class="card border border-info rounded">
                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label" for="notif-2-number">Phone Number:</label>
                                    <input type="text" class="form-control form-control-sm" id="notif-2-number">
                                </div>
                                <div class="form-group">
                                    <label class="control-label" for="notif-2-message">Test Announcement:</label>
                                    <textarea class="form-control form-control-sm" id="notif-2-message"></textarea>
                                </div>
                                <p id="notif-2-send-error" class="text-danger font-italic small ml-2"></p>
                                <div class="form-group text-right">
                                    <button class="btn btn-info btn-sm" onclick="sendNotif2()">Send Announcement</button>
                                    <button class="btn btn-success w-25 btn-sm" onclick="sendNotif2Activity('login')">LOGIN</button>
                                    <button class="btn btn-danger w-25 btn-sm" onclick="sendNotif2Activity('logout')">LOGOUT</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!--Select2-->
<script src="<?php echo $baseUrl;?>/system/plugin/select2/js/select2.min.js"></script>

...
<head>
    ...
    <title><?php echo $schoolName;?> | Staff Attendance Report</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Staff Attendance Report</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button class="btn btn-sm bg-success ml-1" onclick="exportReport()"><span class="fa fa-download"></span> Export</button>
    ...
    <div class="modal fade" id="daily-attendance-modal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Admin and Staff Daily Attendance</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

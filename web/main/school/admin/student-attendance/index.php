...
<head>
    ...
    <title><?php echo $schoolName;?> | Student Attendance Report</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Student Attendance Report</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="input-group input-group-sm float-left mr-2" style="width:200px;">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success">MONTH</span>
                                    </div>
                                    <input type="month" class="form-control" id="month-filter" onchange="getData()" value="<?php echo $date;?>">
                                </div>
                                <button class="btn btn-sm btn-success ml-1" onclick="exportReport()"><span class="fa fa-download"></span> Export</button>
                                <button class="btn btn-sm btn-info ml-1" onclick="showAttendance()"><span class="fa fa-clock"></span> Daily Attendance</button>
                            </div>
                            <div class="card-body">
    ...
    <div class="modal fade" id="student-attendance-modal" data-backdrop="static" data-keyboard="false">
                    ...
                    <div class="row mb-2">
                        <div class="col-3">
                            <div class="input-group input-group-sm">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-success">FROM</span>
                                </div>
                                <input type="date" class="form-control" id="attendance-from" onchange="getAttendance()" value="<?php echo $filterDate;?>">
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="date" class="form-control" id="attendance-to" onchange="getAttendance()" value="<?php echo $filterDate;?>">
                            </div>
                        </div>
                        <div class="col-1">
                            <button class="btn btn-sm bg-success" onclick="exportAttendance()"><span class="fa fa-download"></span></button>
                        </div>
                    </div>
                    
                    <div id="student-attendance-table-container"></div>
                </div>
            </div>
        </div>
    </div>

    <div class="modal fade" id="daily-attendance-modal" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Student Daily Attendance</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="row mb-2">
                        <div class="col d-inline-flex align-items-center">
                            <div class="input-group input-group-sm w-25 mr-2">
                                <div class="input-group-prepend">
                                    <span class="input-group-text bg-success">Date</span>
                                </div>
                                <input type="date" class="form-control" id="show-attendance-filter" onchange="showAttendance()" value="<?php echo $filterDate;?>">
                            </div>
                            <button class="btn btn-sm btn-success d-inline-flex align-items-center" onclick="exportDailyAttendance()"><i class="fa fa-download mr-2"></i> EXPORT</button>
                        </div>
                    </div>

...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3 id="admin-faculty-count">0</h3>
                                    <p>Faculty and Staff Count</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                ...
                                <a href="../manage-student" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3 id="admin-faculty-present">0</h3>
                                    <p><span id="admin-faculty-absent">0</span> Absent Admin and Faculty</p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-list"></i>
                                </div>
                                <a href="#" class="small-box-footer" onclick="showAdminAttendance()">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-6">
                            <!-- small box -->
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    ...
                                    <p><span id="student-absent">0</span> Absent Students</p>
                                </div>
                                <div class="icon">
                                    <i class="fas fa-list"></i>
                                </div>
                                <a href="#" class="small-box-footer" onclick="showStudentAttendance()">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div id="grade-level-attendance-container"></div>
                </div><!-- /.container-fluid -->
            </section><!-- /.content -->
        </div><!-- /.content-wrapper -->
    ...
    <!-- view admin status modal -->
    <div class="modal fade" id="show-admin-attendance-modal" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title w-100">View Faculty and Staff Attendance</h5>
                    <button class="btn btn-primary btn-sm" onclick="exportStaffAttendance()">Export</button>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div id="admin-attendance-table-container"></div>
                    <div id="hidden-admin-attendance-table-container"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="show-student-attendance-modal" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-success">
                    <h5 class="modal-title w-100">View student Attendance</h5>
                    <button class="btn btn-primary btn-sm" onclick="exportStudentAttendance()">Export</button>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div id="hidden-student-attendance-table-container"></div>
                </div>
            </div>
        </div>
    </div>

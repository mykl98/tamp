...
<head>
    ...
    <title><?php echo $schoolName;?> | Profile Settings</title>
    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="" data-toggle="dropdown" href="#">
                        <img id="global-user-image" class="rounded" src="<?php echo $baseUrl;?>/system/images/blank-profile.png" width="40px" height="40px">
                    </a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:<?php echo $brandColor;?>">
            ...
            <a href="#" class="brand-link text-center pb-0">
                <img id="global-client-logo" src="<?php echo $schoolImage;?>" class="rounded-circle mb-2 w-50">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" data-dismiss="modal" onclick="savePassword()">Change</button>
                </div>
            </div>
        </div>
    </div>

...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="addSection()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-section-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-section-modal-title">Add New Section</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="section-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="section-name">
                        </div>
                        <div id="grade-select-container"></div>
                        <div class="form-group">
                            <label for="section-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="section-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-section-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" onclick="saveSection()">Save</button>
                </div>
            </div>
        </div>
    </div>

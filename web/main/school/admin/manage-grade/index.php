...
<head>
    ...
    <title><?php echo $schoolName;?> | Manage Grade Level</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Grade Level</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Manage Grade Level</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="addGrade()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-grade-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-grade-modal-title">Add New Grade Level</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="grade-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="grade-name">
                        </div>
                        <div class="form-group">
                            <label for="grade-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="grade-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-grade-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" onclick="saveGrade()">Save</button>
                </div>
            </div>
        </div>
    </div>

...
<head>
    ...
    <title><?php echo $schoolName;?> | Manage Position</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Position</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Manage Position</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="addPosition()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
                                <div id="position-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-position-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-position-modal-title">Add New Position</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="position-name" class="col-form-label">Name:</label>
                            <input type="text" class="form-control" id="position-name">
                        </div>
                        <div class="form-group">
                            <label for="position-status" class="col-form-label">Status:</label>
                            <select class="form-control" id="position-status">
                                <option value="active">Active</option>
                                <option value="inactive">Inactive</option>
                            </select>
                        </div>
                    </form>
                    <p id="add-edit-position-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" onclick="savePosition()">Save</button>
                </div>
            </div>
        </div>
    </div>

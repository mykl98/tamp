...
<head>
    ...
    <title><?php echo $schoolName;?> | Kiosk Announcement</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Kiosk Announcements</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Kiosk Announcements</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="addAnnouncement()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
                                <div id="announcement-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>

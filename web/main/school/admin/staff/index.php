...
<head>
    ...
    <title><?php echo $schoolName;?> | Manage Staff</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="add()"><span class="fa fa-plus"></span> New</button>
                            </div>
                            <div class="card-body">
    ...
    <!-- Modals -->
    <div class="modal fade" id="add-edit-modal" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="add-edit-staff-title">New Staff</h5>
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group text-center">
                                    ...
                                    <img id="staff-image" class="cursor-pointer w-100 border border-grey rounded" src="<?php echo $baseUrl;?>/system/images/no-image-available.jpg" onclick="$('#load-image-btn').click()">
                                </div>
                                <div class="form-group">
                                    <label for="staff-id" class="col-form-label">ID:</label>
                                    <input type="text" class="form-control form-control-sm" id="staff-id" placeholder="Scan an ID Card..." readonly>
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="staff-firstname" class="col-form-label">Firstname:</label>
                                    <input type="text" class="form-control" id="staff-firstname">
                                </div>
                                <div class="form-group">
                                    <label for="staff-middlename" class="col-form-label">Middlename:</label>
                                    <input type="text" class="form-control" id="staff-middlename">
                                </div>
                                <div class="form-group">
                                    <label for="staff-lastname" class="col-form-label">Lastname:</label>
                                    <input type="text" class="form-control" id="staff-lastname">
                                </div>
                            </div>
                            <div class="col">
                                <div id="position-select-container"></div>
                                <div class="form-group">
                                    <label for="staff-status" class="col-form-label">Status:</label>
                    ...
                    <p id="add-edit-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" onclick="save()">Save</button>
                </div>
            </div>
        </div>
    </div>

...
<head>
    ...
    <title><?php echo $schoolName;?> | Manage Admin</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Manage Admin</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <button class="btn btn-sm bg-success" onclick="add()"><span class="fa fa-plus"></span> Add</button>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group text-center">
                                    ...
                                    <img id="account-image" class="cursor-pointer w-100 border border-grey rounded" src="<?php echo $baseUrl;?>/system/images/no-image-available.jpg" onclick="$('#load-image-btn').click()">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                    <label for="account-firstname" class="col-form-label">Firstame:</label>
                                    <input type="text" class="form-control form-control-sm" id="account-firstname">
                                </div>
                                <div class="form-group">
                                    <label for="account-middlename" class="col-form-label">Middlename:</label>
                                    <input type="text" class="form-control form-control-sm" id="account-middlename">
                                </div>
                                <div class="form-group">
                                    <label for="account-lastname" class="col-form-label">Lastname:</label>
                                    <input type="text" class="form-control form-control-sm" id="account-lastname">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-sm" id="account-status">

<?php
    if($_POST){
        ...
        function getAttendance($date, $school){
            global $conn;
            $data = array();
        ...
        function getDashboardDetails($date, $section,$school){
            $data = array();
            $value = new \StdClass();
            $value -> studentlist = getStudentList($section,$school);
            $value -> attendance = getAttendance($date, $school);
            array_push($data,$value);
        ...
        if($_SESSION["isLoggedIn"] == "true"){
            ...
            echo getDashboardDetails($date, $section, $school);
        }else{
            echo "Access Denied!";
        }
    }else{

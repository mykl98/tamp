...
<head>
    ...
    <title><?php echo $schoolName;?> | Student Attendance</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="input-group input-group-sm w-25 float-left pr-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text bg-success">date</span>
                                    </div>
                                    <input type="date" class="form-control" id="datefilter" value="<?php echo date("Y-m-d");?>" onchange="getDashboardDetail()">
                                </div>
                                <button class="btn btn-sm bg-success" onclick="exportSummary()"><span class="fa fa-copy"></span> Export</button>
                            </div>
                            <div class="card-body">
                                <div id="table-container"></div>
                                <div id="hidden-table-container"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="send-notif-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="send-notif-modal-title">Send Message to</h5>
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group">
                            <label for="notif-message" class="col-form-label">Message:</label>
                            <textarea type="text" class="form-control" id="notif-message"></textarea>
                        </div>
                    </form>
                    <p id="send-notif-modal-error" class="text-danger font-italic small"></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary w-25" onclick="sendNotif()">Send</button>
                </div>
            </div>
        </div>
    </div>

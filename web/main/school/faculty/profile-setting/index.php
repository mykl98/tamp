...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:<?php echo $brandColor;?>">
            ...
            <a href="#" class="brand-link text-center pb-0">
                <img id="global-client-logo" src="<?php echo $schoolImage;?>" class="rounded mb-2" width="100px">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mt-2 mb-5">
                                    ...
                                    <p id="save-profile-error" class="text-danger font-italic small"></p>
                                    <div class="form-group">
    ...
    <div class="modal fade" id="change-password-modal" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal" id="profile-image-editor-modal" data-backdrop="static" data-keyboard="false">
